  ...
  describe("CSS loaders", () => {
    describe("development", () => {
      ...
      it("should exclude modules from the regular loader", () => {
        expect(cssLoader.exclude).toEqual(
          new RegExp(`${path.sep}src${path.sep}components${path.sep}`)
        );
      });
      ...
      it("should create a modules loader", () => {
        ...
        expect(cssModulesLoader.exclude).toEqual(
      ...
      it("should allow override of localIdentName", () => {
        ...
        expect(cssModulesLoader2.exclude).toEqual(
          new RegExp(`${path.sep}node_modules${path.sep}`)
        );
    ...
    describe("development", () => {
      ...
      describe("regular loader", () => {
        it("should configure a regular loader", () => {
          ...
          expect(lessLoader.exclude).toEqual(
            new RegExp(`${path.sep}src${path.sep}components${path.sep}`)
          );
        });
      ...
      describe("modules loader", () => {
        it("should configure a modules loader", () => {
          expect(lessModulesLoader.test).toEqual(/\.less$/);
        });
        it("should build upon the CSS loader", () => {
